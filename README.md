...
If you do not configure a BYO provider, TSRS keeps using the built-in macOS `/usr/bin/say` path. Kokoro and Speechify are optional advanced settings, not product prerequisites.
