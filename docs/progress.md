...
3. SQLite-backed queue core supports enqueue, list, clear, focus, ready, mute, unmute, and claim-next-for-speech.
...
6. Perry is documented as a local library used for safe spoken update conventions.
